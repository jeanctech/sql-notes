-- * Basic Declarations - Sql *

/* Basic statements in Sql are commands that are used to perform various operations on a database. Below
are some of the most common and essential Sql statements. */

--? 1. Create Table

/* This statement is used to create a new table in a database. You must
...
/* This statement allows modifications to be made to an existing table, such as adding, modifying or
deleting columns. Also used to add restrictions. */
