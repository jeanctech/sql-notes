...
--? 4. Sort results
    ...
    -- To sort the results of a query based on the "name" column in alphabetical order upward
...
/* These are just some of the most common SQL queries. You can combine these clauses and sentences to
create more complex queries and get the specific information you need from your database. */